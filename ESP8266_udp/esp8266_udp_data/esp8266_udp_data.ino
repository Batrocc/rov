...
const char* ssid = "EYTHOR";         // Replace with your network SSID (name)
const char* password = "air88255";      // Replace with your network password

const char* udpAddress = "192.168.1.108"; // IP address of your PC
